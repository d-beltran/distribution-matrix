...
class Door:
    ...
    def relocate (self, polygon : Optional[Polygon] = None) -> bool:
        ...
        parent_corridor_boundaries = parent_room.corridor_grid.boundaries if parent_room else []
...
class Room:
    ...
    def set_corridor (self, protocol : int = 2) -> Optional[List['Segment']]:
        ...
        # In protocol 0 we return now the backbone corridor segments and node points
        if protocol == 0:
